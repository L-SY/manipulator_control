#include "manipulator_gazebo/ManipulatorHWSim.h"
#include <gazebo_ros_control/gazebo_ros_control_plugin.h>

namespace Manipulator
{
bool ManipulatorHWSim::initSim(const std::string& manipulator_namespace, ros::NodeHandle model_nh,
                         gazebo::physics::ModelPtr parent_model, const urdf::Model* urdf_model,
                         std::vector<transmission_interface::TransmissionInfo> transmissions)
{
  bool ret = DefaultRobotHWSim::initSim(manipulator_namespace, model_nh, parent_model, urdf_model, transmissions);
...
void ManipulatorHWSim::readSim(ros::Time time, ros::Duration period)
{
  //  gazebo_ros_control::DefaultManipulatorHWSim::readSim(time, period); The
  //  DefaultManipulatorHWSim Provide a bias joint velocity
...
void ManipulatorHWSim::writeSim(ros::Time time, ros::Duration period)
{
  if (!hybridJoints_.empty())
  {
    for (auto joint : hybridJointDatas_)
...
void ManipulatorHWSim::parseImu(XmlRpc::XmlRpcValue& imuDatas, const gazebo::physics::ModelPtr& parentModel)
{
...
PLUGINLIB_EXPORT_CLASS(Manipulator::ManipulatorHWSim, gazebo_ros_control::RobotHWSim)
