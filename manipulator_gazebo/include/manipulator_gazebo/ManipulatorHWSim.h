...
class ManipulatorHWSim : public gazebo_ros_control::DefaultRobotHWSim
{
public:
  bool initSim(const std::string& manipulator_namespace, ros::NodeHandle model_nh, gazebo::physics::ModelPtr parent_model,
